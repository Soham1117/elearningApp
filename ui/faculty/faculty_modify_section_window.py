# Form implementation generated from reading ui file '.\faculty_modify_section_window.ui'
#
...
class Ui_FacutyModifySectionWindow(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(180, 140, 349, 291))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "Unique Section ID:"))
        self.pushButton.setText(_translate("Form", "Add New Content Block"))
        self.pushButton_2.setText(_translate("Form", "Modify Content Block"))
        self.pushButton_3.setText(_translate("Form", "Hide Section"))
        self.pushButton_back.setText(_translate("Form", "Delete Section"))
