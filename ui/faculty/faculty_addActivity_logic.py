...
from ui.faculty.faculty_addActivity_window import Ui_FacultyAddActivityWindow
from ui.faculty.faculty_addQuestion_logic import FacultyAddQuestionLogic

class FacultyAddActivityLogic(QtWidgets.QWidget):
    def __init__(self, args):
        super().__init__()
        self.ui = Ui_FacultyAddActivityWindow()
    ...
    def handle_add_new_activity(self):
        ...
        if response:
            ...
            if response_2:
                ...
                self.ui_ta_addNewQuestion = FacultyAddQuestionLogic([self, self.textbook_id, self.chapter_id, self.section_id, self.block_id, unique_activity_id])
