# Form implementation generated from reading ui file 'faculty_add_new_section_window.ui'
#
...
class Ui_FacultyAddNewSectionWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.layoutWidget = QtWidgets.QWidget(parent=Form)
        self.layoutWidget.setGeometry(QtCore.QRect(140, 190, 428, 148))
...
"    }")
        ...
        self.label.setGeometry(QtCore.QRect(215, 117, 241, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "Unique Section ID:"))
