# Form implementation generated from reading ui file 'faculty_add_block_text_window.ui'
#
...
class Ui_FacultyAddTextWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(250, 87, 121, 41))
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(100, 160, 428, 148))
