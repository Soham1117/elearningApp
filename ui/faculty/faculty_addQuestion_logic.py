...
from ui.faculty.faculty_addQuestion_window import Ui_FacultyAddQuestionWindow

class FacultyAddQuestionLogic(QtWidgets.QWidget):
    def __init__(self, args):
        super().__init__()
        self.ui = Ui_FacultyAddQuestionWindow()
