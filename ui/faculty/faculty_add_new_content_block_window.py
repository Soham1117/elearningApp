# Form implementation generated from reading ui file 'faculty_add_new_content_block_window.ui'
#
...
class Ui_FacultyAddContentBlockWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.layoutWidget = QtWidgets.QWidget(parent=Form)
        self.layoutWidget.setGeometry(QtCore.QRect(210, 140, 332, 241))
...
"    }")
        ...
        self.label.setGeometry(QtCore.QRect(200, 50, 321, 41))
        font = QtGui.QFont()
