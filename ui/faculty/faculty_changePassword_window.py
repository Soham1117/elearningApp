# Form implementation generated from reading ui file '.\faculty_changePassword_window.ui'
#
...
class Ui_FacultyChangePasswordWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(182, 50, 341, 41))
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(160, 123, 385, 199))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Faculty Change Password"))
