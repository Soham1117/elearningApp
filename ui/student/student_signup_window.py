# Form implementation generated from reading ui file 'student_signup_window.ui'
#
...
class Ui_StudentSignupWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(100, 50, 531, 41))
        font = QtGui.QFont()
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Student Sign Up"))
