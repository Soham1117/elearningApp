# Form implementation generated from reading ui file 'student_viewSection_window.ui'
#
...
class Ui_StudentViewSectionWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(140, 50, 441, 41))
        font = QtGui.QFont()
        ...
        self.widget.setGeometry(QtCore.QRect(133, 132, 451, 199))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "View Section"))
        self.label_2.setText(_translate("Form", "Textbook ID:"))
        self.label_4.setText(_translate("Form", "Chapter ID:"))
        self.label_5.setText(_translate("Form", "Section ID:"))
        self.pushButton.setText(_translate("Form", "View Block"))
