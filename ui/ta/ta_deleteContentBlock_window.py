# Form implementation generated from reading ui file 'ta_deleteContentBlock_window.ui'
#
...
class Ui_TaDeleteContentBlockWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(120, 67, 451, 41))
        font = QtGui.QFont()
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Delete Content Block"))
