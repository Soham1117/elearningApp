# Form implementation generated from reading ui file 'ta_modifySection_window.ui'
#
...
class Ui_TaModifySectionWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.widget = QtWidgets.QWidget(parent=Form)
        self.widget.setGeometry(QtCore.QRect(60, 30, 591, 291))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_7.setText(_translate("Form", "Section Title:"))
        ...
        self.pushButton_4.setText(_translate("Form", "Hide Content Block"))
        self.pushButton_3.setText(_translate("Form", "Delete Content Block"))
