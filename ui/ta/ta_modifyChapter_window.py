# Form implementation generated from reading ui file 'ta_modifyChapter_window.ui'
#
...
class Ui_TaModifyChapterWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.layoutWidget = QtWidgets.QWidget(parent=Form)
        self.layoutWidget.setGeometry(QtCore.QRect(170, 130, 386, 254))
