...
from ui.ta.ta_changePassword_window import Ui_TaChangePasswordWindow

class TAChangePasswordLogic(QtWidgets.QWidget):
    def __init__(self, args):
        super().__init__()
        self.ui = Ui_TaChangePasswordWindow()
    ...
    def change_password(self):
        ...
        if new_password == confirm_new_password:
            if self.user_dao.change_password_ta(self.ta_id, current_password, new_password):
