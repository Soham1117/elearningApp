...
from ui.ta.ta_viewCourses_window import Ui_TaViewCoursesWindow

class TAViewCoursesLogic(QtWidgets.QWidget):

    def __init__(self, args):
        super().__init__()
        self.ui = Ui_TaViewCoursesWindow()
    ...
    def display_courses(self):
        result = self.user_dao.view_courses_ta(self.ta_id)
        if not result[1]:
